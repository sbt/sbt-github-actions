...
trait GenerativeKeys {
  ...
  lazy val githubWorkflowPublishBranchGlobs = settingKey[Seq[String]]("A set of globs which will be applied to determine which branches get a publication stage; if empty, publish will be skipped (default: [master])")
