...
trait GenerativeKeys {
  ...
  lazy val githubWorkflowJavaVersions = settingKey[Seq[JavaSpec]]("A list of Java versions to be used for the build job. (default: [zulu@8])")
  lazy val githubWorkflowPublishJavaVersion = settingKey[JavaSpec]("A Java versions to be used for the publish job. (default: [zulu@8])")
